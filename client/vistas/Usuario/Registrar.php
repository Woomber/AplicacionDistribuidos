...
<div class="container center">
	<form action="usuario.php?c=Usuario&a=Registrar" class="form-horizontal center" method="POST">
		<div class="panel panel-info">
            <div class="panel-heading">
                <h4><i class='glyphicon glyphicon-log-in' style="margin-right: 10px;"></i>Registro</h4>
            </div>
			...
			<div class="panel-footer">
				...
				<a class="btn btn-default" href="usuario.php?c=Usuario&a=Ingresar">Ingresar</a>
            </div>
		</div>
	</form>
</div>